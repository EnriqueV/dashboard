...
demo = {
    ...
    initDashboardPageCharts: function() {
        ...
        var dataSales = {
            labels: ['San Salvador', 'Santa Ana', 'San Miguel', 'Cuscatlan', 'Merliot'],
            series: [
                [35, 46, 49, 49, 55, 58, 69, 65, 75],
                [47, 15, 14, 24, 28, 35, 43, 43, 53],
        ...
        var chartProduct = Chartist.Bar('#charProduct', data, options, responsiveOptions);
    ...
    showNotification: function(from, align) {
        ...
        $.notify({
            icon: "nc-icon nc-app",
            message: "Laboratorios Arsal, bienvenido"
